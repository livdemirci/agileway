...
public class ReusableMethods {
    ...
    public static void retryableSeleniumOperation(int retryCount, long waitTimeInMiliSeconds, Runnable seleniumAction) throws InterruptedException {
        boolean flag = false;

        while (retryCount > 0 && !flag) {
            try {
                // Selenium işlemi burada gerçekleştirilir
                seleniumAction.run();
                flag = true;
